...
export class RateLimitService {
  ...
  checkRateLimit(
    ...
    const headers = {
      ...
      [RATE_LIMIT_HEADERS.RETRY_AFTER]: Math.ceil(
    ...
    return {
      allowed,
      headers,
      retryAfter: headers[RATE_LIMIT_HEADERS.RETRY_AFTER],
    };
  }
  ...
  private getUserMultiplier(role?: string): number {
    ...
    return (
      USER_ROLE_MULTIPLIERS[role as keyof typeof USER_ROLE_MULTIPLIERS] ||
