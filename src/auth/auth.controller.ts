...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Requires email and password. If 2FA is enabled, requires 2FA code.',
  })
  @ApiResponse({
    status: 201,
  ...
  @Post('2fa/setup')
  @ApiOperation({
    summary: 'Setup 2FA (TOTP or SMS)',
    description: 'Initiate 2FA setup for the user.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Verify a TOTP or SMS code for 2FA.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Enable 2FA after successful verification.',
  })
  enable2FA(@Req() req) {
  ...
  @ApiOperation({
    ...
    description: 'Creates a new user account. Rate limited to prevent abuse.',
  })
  @ApiResponse({
    status: 201,
