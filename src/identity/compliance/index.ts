...
export { IdentityComplianceService, ComplianceStatus, COMPLIANCE_EVENTS } from './identity-compliance.service';
export type { UserComplianceRecord, ComplianceFlagRaisedEvent } from './identity-compliance.service';