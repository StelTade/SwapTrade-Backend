...
export const PERMISSION_REGISTRY: PermissionDefinition[] = [
  // ── Users ──────────────────────────────────────────────────────
  {
    ...
    action: 'read',
    slug: 'users.read',
    description: 'Read user profiles and data',
  },
  {
    resource: 'users',
    action: 'write',
  ...
  // ── Accounts ───────────────────────────────────────────────────
  {
    ...
    action: 'read',
    slug: 'accounts.read',
    description: 'Read account balances and details',
  },
  {
    resource: 'accounts',
    action: 'write',
  ...
  // ── Trades ─────────────────────────────────────────────────────
  {
    ...
    action: 'read',
    slug: 'trades.read',
    description: 'View trade history and positions',
  },
  {
    resource: 'trades',
    action: 'write',
  ...
  },
  {
    ...
    action: 'manage',
    slug: 'trades.manage',
    description: 'Full trade management access',
  },
  ...
  },
  {
    ...
    action: 'manage',
    slug: 'admin.manage',
    description: 'Full admin management access',
  },
  ...
  },
  {
    resource: 'compliance',
    action: 'write',
    slug: 'compliance.write',
    description: 'Create compliance records',
  },
  {
    resource: 'compliance',
    action: 'manage',
  ...
  },
  {
    ...
    action: 'manage',
    slug: 'kyc.manage',
    description: 'Full KYC management access',
  },
];
...
export const ALL_PERMISSION_SLUGS: string[] = PERMISSION_REGISTRY.map(
  (p) => p.slug,
);
