...
export const ROLE_METADATA: Record<UserRole, RoleMetadata> = {
  ...
  [UserRole.INSTITUTIONAL_CLIENT]: {
    name: UserRole.INSTITUTIONAL_CLIENT,
    description:
      'Institutional Client - High-volume trading, bulk APIs, custom reporting, SLA-backed support, and compliance features',
    priority: 45,
    permissions: [
      'trades.read',
      'trades.write',
      ...
      'ADVANCED_TRADING',
      'MARGIN_TRADING',
      'INSTITUTIONAL_API_ACCESS',
      'INSTITUTIONAL_BULK_TRADING',
      'INSTITUTIONAL_REPORTING',
      'INSTITUTIONAL_RECONCILIATION',
      'INSTITUTIONAL_SLA_MANAGEMENT',
      'INSTITUTIONAL_SUPPORT_PRIORITY',
      'INSTITUTIONAL_ACCOUNT_MANAGEMENT',
      'INSTITUTIONAL_QUOTA_MANAGEMENT',
      'INSTITUTIONAL_PORTAL_ACCESS',
    ],
    constraints: {
      maxUsers: undefined,
      maxDailyActions: 1_000_000,
    },
  },
